...
router.get("/:searchparam", (req, res) => {
  ...
  axios.post(URL, `url=${req.params.searchparam}&q_auto=0&ajax=1`).then(response => {
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(85).concat(__webpack_require__(86)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(89).concat(__webpack_require__(90)) },
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(142)(module)))
